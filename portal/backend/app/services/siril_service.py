...
class SirilService:
    ...
    def _execute_siril_script(self, script_path: Path, working_dir: Path) -> ProcessingResult:
        """
        ...
        try:
            ...
            return ProcessingResult(
                success=True, status=ProcessingStatus.COMPLETE, siril_output=result.stdout
            )
