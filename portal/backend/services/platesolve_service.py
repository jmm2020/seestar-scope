...
class ASTAPService:
    ...
    async def solve_hint(
        ...
        # ASTAP uses -spd (south pole distance = 90 + dec)
    ...
    async def _execute_astap(self, cmd: List[str], image_path: Path) -> WCSSolution:
    ...
    def _calculate_offset(
        ...
        ra1 = math.radians(expected_ra_hours * 15.0)
        ...
        separation_arcsec = math.degrees(c) * 3600.0
